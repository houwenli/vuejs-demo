		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<div v-if="seller.supports" v-on:click="showDetail" class="support">
					<span class="icon" v-bind:class="classMap[seller.supports[1].type]"></span> 
				...
				.detail-main {
					...
					.supports {
					  ...
					  .support-item {
						  ...
						  font-size: 0;
						  .icon.decrease {
								background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACAAAAAgCAYAAABzenr0AAAAGXRFW…f3/x3L/ySAxxLjxwBwViKAISV/z4+5xzP8ex4nMVvvAgwAfUE0sZNv/EQAAAAASUVORK5CYII=);
							}
							.icon {
							  display: inline-block;
							  width: 16px;
